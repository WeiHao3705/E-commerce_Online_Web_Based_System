...
<body data-user-id="<?php echo (int)$user['user_id']; ?>" data-controller-url="<?php echo $prefix; ?>controller/MemberController.php">
    ...
    <script src="<?php echo $prefix; ?>js/adminProfile.js"></script>
</body>
</html>
