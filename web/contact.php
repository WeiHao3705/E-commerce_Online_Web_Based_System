              ...
              <div class="contact-info-section">
                <div class="contact-info-block">
                  ...
                  <div class="contact-info-list">
                    ...
                    <a href="https://maps.app.goo.gl/i7LTUmW393c93moH9" target="_blank" class="contact-info-item" style="text-decoration: none; color: inherit;">
                      <div class="contact-icon-box">
                  ...
                  <div class="contact-social">
                    <a class="contact-social-link" href="https://www.facebook.com/chan.w.song.73" aria-label="Facebook" target="_blank">
                    ...
                    <a class="contact-social-link" href="https://www.instagram.com/hermen__chan?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" aria-label="Instagram" target="_blank">
                      <svg class="contact-social-icon" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
