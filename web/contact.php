              ...
              <div class="flex flex-col gap-8">
                <div class="flex flex-col gap-6">
                  ...
                  <div class="flex gap-4 pt-2">
                    <a class="flex h-10 w-10 items-center justify-center rounded-lg bg-[#f3e7e7] dark:bg-[#2a1a1a] text-[#1b0d0d] dark:text-[#f8f6f6] hover:bg-[#e7d7d7] dark:hover:bg-[#3a2a2a] transition-colors" href="https://www.facebook.com/chan.w.song.73" aria-label="Facebook">
                    ...
                    <a class="flex h-10 w-10 items-center justify-center rounded-lg bg-[#f3e7e7] dark:bg-[#2a1a1a] text-[#1b0d0d] dark:text-[#f8f6f6] hover:bg-[#e7d7d7] dark:hover:bg-[#3a2a2a] transition-colors" href="https://www.instagram.com/hermen__chan?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" aria-label="Instagram">
                      <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
